...
<body class="bg-neutral-600">
    <header>
        <div class="flex flex-row items-center pt-2 mb-5 bg-neutral-400 pb-2">
            ...
            <div class="basis-1/3 flex items-center justify-between rounded-md bg-violet-300 h-8">   
                ...
                <img src="/assets/magnifying-glass-solid.svg" class="w-5 h-5 hover:cursor-pointer mx-1">
            </div>
    ...
    <footer class="pt-4 bg-gradient-to-tr to-neutral-600 from-neutral-950">
            <p>Footer</p>
            <div class="footer-icons">
                <img src="/assets/gitlab.svg" class="w-5 h-5 mx-1">
