...
<body class="bg-headerMenu">
    <header>
        <div class="flex flex-row items-start flex-wrap sm:flex-nowrap justify-between sm:justify-normal sm:items-center pt-2 bg-headerMenu pb-2 mr-4">
            ...
            <div class="basis-1/3 flex justify-center mr-2 sm:mr-3 mt-4 sm:mt-0 sm:justify-end text-textTitle <?php if(!$logged){echo 'hidden';}?> ">
                <button class="bg-hover hover:bg-textBase hover:text-fondo rounded-md py-2 px-3 mx-2 sm:mx-2 hover:cursor-pointer whitespace-nowrap" onclick="goTo('logIn','logOut')">Log Out</button> 
            </div>
        </div>
    </header>
